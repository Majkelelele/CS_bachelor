...
.loop:                                          ;główna pętla programy, dla każdej komórki i, n>i>1 algorytm jest taki sam
 ...
 xor r11, r11
 mov r11, [rdi + 8*r9]                          ;przenosze wartość x[i] do rdx
 sar r11, cl                                    ;przesunięcie upper x[i] o 64 - floor(64 * i * i / n) (mod 64)
...
.non_negative:                                  ;obecna suma nieujemna
 ...
 test r11, r11
 js .negativeUpperBits 
 add [rdi + 8*rax + 8], r11                     ;dodaje upper x[i] do sumy razem z możliwym bitem dodatkowym z wcześniejszego dodawania
